...
**Current release:** `0.4.20-beta` &nbsp;|&nbsp; **Minimum Java:** `11`

**Maven Central coordinates:** `org.openjproxy:ojp-jdbc-driver:0.4.20-beta`
...
```groovy
dependencies {
    implementation 'org.openjproxy:ojp-jdbc-driver:0.4.20-beta'
    // ... other dependencies
}
```
