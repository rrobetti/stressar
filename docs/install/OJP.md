...
**Current release:** `0.4.20-beta` &nbsp;|&nbsp; **Server gRPC port:** `1059`

| Artifact | Maven Central URL                                                                                           |
|---|-------------------------------------------------------------------------------------------------------------|
| OJP Server (shaded) | <https://repo1.maven.org/maven2/org/openjproxy/ojp-server/0.4.20-beta/ojp-server-0.4.20-beta-shaded.jar>    |
| OJP JDBC Driver | <https://repo1.maven.org/maven2/org/openjproxy/ojp-jdbc-driver/0.4.20-beta/ojp-jdbc-driver-0.4.20-beta.jar> |
...
sudo curl -L \
  https://repo1.maven.org/maven2/org/openjproxy/ojp-server/0.4.20-beta/ojp-server-0.4.20-beta-shaded.jar \
  -o /opt/ojp/bin/ojp-server-0.4.20-beta-shaded.jar
```
...
java -Duser.timezone=UTC \
     ...
     -jar /opt/ojp/bin/ojp-server-0.4.20-beta-shaded.jar
```
